#!/usr/bin/env python3
"""Materialize the exact ADR-0036 project-owner semantic disposition records."""
...
from enterprise_governance_semantic_acceptance_runtime import build_records, persist_records
...
def main() -> int:
    ...
    summary = {"status": "owner_finalized", "adr": "ADR-0036", "disposition": disposition["disposition"],
               ...
               "eligibility_state": eligibility["state"], "ent_gov_scheduled": False, "ent_synth_scheduled": False,
