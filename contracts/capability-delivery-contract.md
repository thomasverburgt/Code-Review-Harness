...
Capability scores represent technical confidence, coverage, evidence quality, and cross-product readiness. UI/UX remains a product-level concern; the capability layer assesses end-to-end human factors, handoffs, and operator effort.
